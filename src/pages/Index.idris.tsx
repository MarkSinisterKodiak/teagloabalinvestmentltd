          ...
          <div className="flex justify-center lg:justify-start gap-4 xs:gap-6 sm:gap-10">
            <div className="text-center">
              <div className="flex items-center justify-center gap-1">
                ...
                <span className="text-xl xs:text-2xl sm:text-3xl font-display font-bold text-white">All UK</span>
              </div>
  ...
  <div className="relative py-16 sm:py-20 overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
        {[
          { value: "All UK", label: "Coverage", icon: Truck },
      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="absolute -bottom-6 -right-4 sm:right-8 bg-white rounded-2xl shadow-xl p-5 border border-gray-100 hidden sm:block">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">Based Transport</div>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Your Trusted <br />
            <span className="text-blue-700">Transport Partner Since {company.established}</span>
          </h2>
          <p className="text-gray-600 text-base sm:text-lg mb-8 leading-relaxed">
            {company.name} provides professional transport and logistics services across the United Kingdom.
            We handle your cargo with care — secure loading, safe transport, and on-time delivery every load.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            {[
              { icon: Truck, text: "UK-wide transport" },
...
const TruckCtaBanner = () => (
  <div className="relative py-20 sm:py-24 overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
      ...
      <p className="text-blue-100 text-lg sm:text-xl mb-8 max-w-2xl mx-auto">Get a free quote from our transport team and discover the best logistics solution for your freight.</p>
...
const services = [
  {
    ...
    description: "Reliable freight and cargo transport across the UK. From pallets to full truckloads, we deliver on time.",
  },
  {
    icon: Building2,
  ...
  },
  {
    ...
    description: "Every load is fully insured for your peace of mind. GPS-tracked vehicles with real-time updates on your cargo.",
  },
];
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
      <div className="text-center mb-12 md:mb-16">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-gray-900">
          Transport <span className="text-blue-700">Services</span>
        </h2>
        <p className="text-gray-500 max-w-2xl mx-auto text-base sm:text-lg">
          Professional transport and logistics services to move your cargo safely, on time, every time.
        </p>
      </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 xs:gap-4">
                      <div className="space-y-1.5">
                        ...
                        >
                          ...
                          <option>Nationwide Transport</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Tell us more about your transport needs (load type, weight, dimensions, access requirements, preferred date, etc.)..."
                      rows={3}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xs:gap-8 sm:gap-10 lg:gap-12 xl:gap-16 items-start lg:items-center">
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="text-gray-300 mb-4 xs:mb-6 sm:mb-8 text-xs xs:text-sm sm:text-base lg:text-lg max-w-xl mx-auto lg:mx-0">
              Join a growing transport team in the UK. We're looking for dedicated professionals
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10 sm:mb-14">
        <div className="col-span-2 lg:col-span-1">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Your trusted transport partner in the UK. Professional freight and cargo transport across the United Kingdom.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-gray-400">
            <li><button onClick={() => scrollToSection("services")} className="hover:text-blue-400 transition-colors">General Transport</button></li>
